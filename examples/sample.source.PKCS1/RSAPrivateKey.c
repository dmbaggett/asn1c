...
static asn_TYPE_tag2member_t asn_MAP_RSAPrivateKey_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 0, 0, 8 }, /* version at 199 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 1, -1, 7 }, /* modulus at 200 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 2, -2, 6 }, /* publicExponent at 201 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 3, -3, 5 }, /* privateExponent at 202 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 4, -4, 4 }, /* prime1 at 203 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 5, -5, 3 }, /* prime2 at 204 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 6, -6, 2 }, /* exponent1 at 205 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 7, -7, 1 }, /* exponent2 at 206 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 8, -8, 0 }, /* coefficient at 207 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 9, 0, 0 } /* otherPrimeInfos at 208 */
};
