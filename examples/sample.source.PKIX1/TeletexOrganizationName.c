 ...
 */
static void
TeletexOrganizationName_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
TeletexOrganizationName_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	TeletexOrganizationName_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
TeletexOrganizationName_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
TeletexOrganizationName_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TeletexOrganizationName_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
TeletexOrganizationName_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TeletexOrganizationName_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_TeletexOrganizationName_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (20 << 2))
};
asn_TYPE_descriptor_t asn_DEF_TeletexOrganizationName = {
	"TeletexOrganizationName",
	"TeletexOrganizationName",
	TeletexOrganizationName_free,
	TeletexOrganizationName_print,
	TeletexOrganizationName_constraint,
	TeletexOrganizationName_decode_ber,
	TeletexOrganizationName_encode_der,
	TeletexOrganizationName_decode_xer,
	TeletexOrganizationName_encode_xer,
