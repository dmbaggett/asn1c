...
int
UniquePostalName_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
UniquePostalName_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
UniquePostalName_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	UniquePostalName_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
UniquePostalName_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
UniquePostalName_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
UniquePostalName_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
UniquePostalName_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
UniquePostalName_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_UniquePostalName_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (17 << 2))
};
asn_TYPE_descriptor_t asn_DEF_UniquePostalName = {
	"UniquePostalName",
	"UniquePostalName",
	UniquePostalName_free,
	UniquePostalName_print,
	UniquePostalName_constraint,
	UniquePostalName_decode_ber,
	UniquePostalName_encode_der,
	UniquePostalName_decode_xer,
	UniquePostalName_encode_xer,
