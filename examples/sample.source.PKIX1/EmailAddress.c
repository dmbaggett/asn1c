 ...
 */
static void
EmailAddress_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
EmailAddress_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	EmailAddress_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
EmailAddress_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
EmailAddress_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
EmailAddress_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
EmailAddress_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
EmailAddress_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_EmailAddress_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_EmailAddress = {
	...
	EmailAddress_decode_ber,
	EmailAddress_encode_der,
	EmailAddress_decode_xer,
	EmailAddress_encode_xer,
