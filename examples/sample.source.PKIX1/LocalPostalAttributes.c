...
int
LocalPostalAttributes_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
LocalPostalAttributes_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
LocalPostalAttributes_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	LocalPostalAttributes_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
LocalPostalAttributes_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
LocalPostalAttributes_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
LocalPostalAttributes_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
LocalPostalAttributes_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
LocalPostalAttributes_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_LocalPostalAttributes_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (17 << 2))
};
asn_TYPE_descriptor_t asn_DEF_LocalPostalAttributes = {
	"LocalPostalAttributes",
	"LocalPostalAttributes",
	LocalPostalAttributes_free,
	LocalPostalAttributes_print,
	LocalPostalAttributes_constraint,
	LocalPostalAttributes_decode_ber,
	LocalPostalAttributes_encode_der,
	LocalPostalAttributes_decode_xer,
	LocalPostalAttributes_encode_xer,
