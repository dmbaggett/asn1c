...
static asn_TYPE_member_t asn_MBR_TeletexDomainDefinedAttribute_1[] = {
...
static ber_tlv_tag_t asn_DEF_TeletexDomainDefinedAttribute_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_TeletexDomainDefinedAttribute_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (20 << 2)), 0, 0, 1 }, /* type at 726 */
    { (ASN_TAG_CLASS_UNIVERSAL | (20 << 2)), 1, -1, 0 } /* value at 728 */
};
static asn_SEQUENCE_specifics_t asn_SPC_TeletexDomainDefinedAttribute_specs_1 = {
