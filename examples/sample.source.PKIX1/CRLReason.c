...
static asn_INTEGER_enum_map_t asn_MAP_CRLReason_value2enum_1[] = {
	{ 0,	11,	"unspecified" },
	{ 1,	13,	"keyCompromise" },
	{ 2,	12,	"cACompromise" },
...
static unsigned int asn_MAP_CRLReason_enum2value_1[] = {
	9,	/* aACompromise(10) */
...
static ber_tlv_tag_t asn_DEF_CRLReason_tags_1[] = {
