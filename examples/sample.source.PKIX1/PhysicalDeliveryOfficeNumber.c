...
int
PhysicalDeliveryOfficeNumber_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
PhysicalDeliveryOfficeNumber_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
PhysicalDeliveryOfficeNumber_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	PhysicalDeliveryOfficeNumber_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
PhysicalDeliveryOfficeNumber_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
PhysicalDeliveryOfficeNumber_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
PhysicalDeliveryOfficeNumber_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
PhysicalDeliveryOfficeNumber_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
PhysicalDeliveryOfficeNumber_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_PhysicalDeliveryOfficeNumber_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (17 << 2))
};
asn_TYPE_descriptor_t asn_DEF_PhysicalDeliveryOfficeNumber = {
	"PhysicalDeliveryOfficeNumber",
	"PhysicalDeliveryOfficeNumber",
	PhysicalDeliveryOfficeNumber_free,
	PhysicalDeliveryOfficeNumber_print,
	PhysicalDeliveryOfficeNumber_constraint,
	PhysicalDeliveryOfficeNumber_decode_ber,
	PhysicalDeliveryOfficeNumber_encode_der,
	PhysicalDeliveryOfficeNumber_decode_xer,
	PhysicalDeliveryOfficeNumber_encode_xer,
