...
int
HoldInstructionCode_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
HoldInstructionCode_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
HoldInstructionCode_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	HoldInstructionCode_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
HoldInstructionCode_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
HoldInstructionCode_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
HoldInstructionCode_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
HoldInstructionCode_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
HoldInstructionCode_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_HoldInstructionCode_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (6 << 2))
};
asn_TYPE_descriptor_t asn_DEF_HoldInstructionCode = {
	"HoldInstructionCode",
	"HoldInstructionCode",
	HoldInstructionCode_free,
	HoldInstructionCode_print,
	HoldInstructionCode_constraint,
	HoldInstructionCode_decode_ber,
	HoldInstructionCode_encode_der,
	HoldInstructionCode_decode_xer,
	HoldInstructionCode_encode_xer,
