...
int
PhysicalDeliveryPersonalName_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
PhysicalDeliveryPersonalName_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
PhysicalDeliveryPersonalName_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	PhysicalDeliveryPersonalName_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
PhysicalDeliveryPersonalName_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
PhysicalDeliveryPersonalName_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
PhysicalDeliveryPersonalName_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
PhysicalDeliveryPersonalName_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
PhysicalDeliveryPersonalName_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_PhysicalDeliveryPersonalName_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (17 << 2))
};
asn_TYPE_descriptor_t asn_DEF_PhysicalDeliveryPersonalName = {
	"PhysicalDeliveryPersonalName",
	"PhysicalDeliveryPersonalName",
	PhysicalDeliveryPersonalName_free,
	PhysicalDeliveryPersonalName_print,
	PhysicalDeliveryPersonalName_constraint,
	PhysicalDeliveryPersonalName_decode_ber,
	PhysicalDeliveryPersonalName_encode_der,
	PhysicalDeliveryPersonalName_decode_xer,
	PhysicalDeliveryPersonalName_encode_xer,
