...
int
PostOfficeBoxAddress_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
PostOfficeBoxAddress_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
PostOfficeBoxAddress_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	PostOfficeBoxAddress_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
PostOfficeBoxAddress_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
PostOfficeBoxAddress_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
PostOfficeBoxAddress_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
PostOfficeBoxAddress_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
PostOfficeBoxAddress_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_PostOfficeBoxAddress_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (17 << 2))
};
asn_TYPE_descriptor_t asn_DEF_PostOfficeBoxAddress = {
	"PostOfficeBoxAddress",
	"PostOfficeBoxAddress",
	PostOfficeBoxAddress_free,
	PostOfficeBoxAddress_print,
	PostOfficeBoxAddress_constraint,
	PostOfficeBoxAddress_decode_ber,
	PostOfficeBoxAddress_encode_der,
	PostOfficeBoxAddress_decode_xer,
	PostOfficeBoxAddress_encode_xer,
