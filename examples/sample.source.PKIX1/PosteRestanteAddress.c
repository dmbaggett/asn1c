...
int
PosteRestanteAddress_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
PosteRestanteAddress_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
PosteRestanteAddress_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	PosteRestanteAddress_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
PosteRestanteAddress_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
PosteRestanteAddress_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
PosteRestanteAddress_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
PosteRestanteAddress_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
PosteRestanteAddress_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_PosteRestanteAddress_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (17 << 2))
};
asn_TYPE_descriptor_t asn_DEF_PosteRestanteAddress = {
	"PosteRestanteAddress",
	"PosteRestanteAddress",
	PosteRestanteAddress_free,
	PosteRestanteAddress_print,
	PosteRestanteAddress_constraint,
	PosteRestanteAddress_decode_ber,
	PosteRestanteAddress_encode_der,
	PosteRestanteAddress_decode_xer,
	PosteRestanteAddress_encode_xer,
