...
static asn_TYPE_tag2member_t asn_MAP_Member_tag2el_2[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (6 << 2)), 0, 0, 1 }, /* issuerDomainPolicy at 141 */
    { (ASN_TAG_CLASS_UNIVERSAL | (6 << 2)), 1, -1, 0 } /* subjectDomainPolicy at 142 */
};
...
static ber_tlv_tag_t asn_DEF_PolicyMappings_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
