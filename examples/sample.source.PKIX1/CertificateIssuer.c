 ...
 */
static void
CertificateIssuer_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
CertificateIssuer_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	CertificateIssuer_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
CertificateIssuer_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
CertificateIssuer_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
CertificateIssuer_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
CertificateIssuer_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
CertificateIssuer_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_CertificateIssuer_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
asn_TYPE_descriptor_t asn_DEF_CertificateIssuer = {
	"CertificateIssuer",
	"CertificateIssuer",
	CertificateIssuer_free,
	CertificateIssuer_print,
	CertificateIssuer_constraint,
	CertificateIssuer_decode_ber,
	CertificateIssuer_encode_der,
	CertificateIssuer_decode_xer,
	CertificateIssuer_encode_xer,
