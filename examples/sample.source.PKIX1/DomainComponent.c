...
int
DomainComponent_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
DomainComponent_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
DomainComponent_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	DomainComponent_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
DomainComponent_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
DomainComponent_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
DomainComponent_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
DomainComponent_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
DomainComponent_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_DomainComponent_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (22 << 2))
};
asn_TYPE_descriptor_t asn_DEF_DomainComponent = {
	"DomainComponent",
	"DomainComponent",
	DomainComponent_free,
	DomainComponent_print,
	DomainComponent_constraint,
	DomainComponent_decode_ber,
	DomainComponent_encode_der,
	DomainComponent_decode_xer,
	DomainComponent_encode_xer,
