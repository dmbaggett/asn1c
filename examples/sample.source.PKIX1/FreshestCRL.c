...
FreshestCRL_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_CRLDistributionPoints.free_struct;
	td->print_struct   = asn_DEF_CRLDistributionPoints.print_struct;
	td->ber_decoder    = asn_DEF_CRLDistributionPoints.ber_decoder;
	td->der_encoder    = asn_DEF_CRLDistributionPoints.der_encoder;
	td->xer_decoder    = asn_DEF_CRLDistributionPoints.xer_decoder;
	td->xer_encoder    = asn_DEF_CRLDistributionPoints.xer_encoder;
	td->uper_decoder   = asn_DEF_CRLDistributionPoints.uper_decoder;
	td->uper_encoder   = asn_DEF_CRLDistributionPoints.uper_encoder;
	if(!td->per_constraints)
		td->per_constraints = asn_DEF_CRLDistributionPoints.per_constraints;
	td->elements       = asn_DEF_CRLDistributionPoints.elements;
	td->elements_count = asn_DEF_CRLDistributionPoints.elements_count;
	td->specifics      = asn_DEF_CRLDistributionPoints.specifics;
}
...
static ber_tlv_tag_t asn_DEF_FreshestCRL_tags_1[] = {
