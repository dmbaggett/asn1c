...
int
ExtensionORAddressComponents_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
ExtensionORAddressComponents_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
ExtensionORAddressComponents_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	ExtensionORAddressComponents_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
ExtensionORAddressComponents_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
ExtensionORAddressComponents_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ExtensionORAddressComponents_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
ExtensionORAddressComponents_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ExtensionORAddressComponents_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_ExtensionORAddressComponents_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (17 << 2))
};
asn_TYPE_descriptor_t asn_DEF_ExtensionORAddressComponents = {
	"ExtensionORAddressComponents",
	"ExtensionORAddressComponents",
	ExtensionORAddressComponents_free,
	ExtensionORAddressComponents_print,
	ExtensionORAddressComponents_constraint,
	ExtensionORAddressComponents_decode_ber,
	ExtensionORAddressComponents_encode_der,
	ExtensionORAddressComponents_decode_xer,
	ExtensionORAddressComponents_encode_xer,
